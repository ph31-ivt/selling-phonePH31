                            ...
                            <div style="width: 100%">
                                <div style="width: 70%; display: inline; float: left">
                                    <div style="width: 40%; float: left">
                                        <span style="float: left">Bởi: <strong>{{$comment->user->name}}</strong></span>
                                    </div>
                                    <div style="width: 40%; float: left">
                                        <span style="">Lúc: {{$comment->date_time}}</span>
                                    </div>
                                    <div>
                                        <form action="{{route('comment.destroy',[$comment->product_id, $comment->user_id, $comment->content])}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <button type="submit" style="background: none; border: none" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </div>
                                    <br>
                                </div>
