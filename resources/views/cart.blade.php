...
@section('content')
    <div class="row justify-content-center mt-4">
        <div class="col-md-7">
            ...
            @endforeach
            <div class="row cart-content-total border mb-2 justify-content-end">
                <div class="col-md-4"><p>Tổng tiền: <span>{!! number_format($total) !!} đ</span></p></div>
            </div>
            <div class="row cart-content-inforcustomer">
