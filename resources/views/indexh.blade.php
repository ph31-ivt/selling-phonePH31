            ...
            <div id="productnew" class="carousel1 slide" data-ride="carousel">
                ...
                <div class="container-fluid carousel-inner no-padding">
                    <style>
                        ...
                        .product-grid4 .product-discount-label,.product-grid4 .product-new-label{color:#fff;background-color:#16a085;font-size:12px;font-weight:600;text-transform:uppercase;line-height:35px;height:35px;width:35px;border-radius:50%;position:absolute;left:3px;top:5px;transition:all .3s}
                ...
                {{--                    <a class="carousel-control-prev" href="#productnew" data-slide="prev">--}}
                {{--                        <span class="carousel-control-prev-icon"></span>--}}
                {{--                    </a>--}}
                {{--                    <a class="carousel-control-next" href="#productnew" data-slide="next">--}}
